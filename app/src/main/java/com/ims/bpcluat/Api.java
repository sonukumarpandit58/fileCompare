...
public class Api {
    ...
    private static String baseUrl = "https://www.uat.fdmerchantservices.com/L3Services/v1/IOCL/";
    private static String loginBaseUrl = "https://www.uat.fdmerchantservices.com/L3Services/v2/IOCL/";
    private static String signKey = "7DAM1JFH3TUXL5WEYEAWTPMSSU8YE5VA";
    private static String encKey = "8INX9NJ7O7VLBJOVIGOBDBJQFWPAL0WI";
    ...
    public void networking(JSONObject args,String apiName, String timeoutstr) {
        ...
        final String SequenceNo = "IOCL" + UUID.randomUUID().toString().substring(0, 7);
        try {
