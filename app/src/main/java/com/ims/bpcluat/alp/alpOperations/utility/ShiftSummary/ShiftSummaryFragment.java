...
public class ShiftSummaryFragment extends Fragment implements ApiHelper.NetworkingApiCallBack {
    FragmentShiftSummaryBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentShiftSummaryBinding.inflate(inflater, container, false);
        context = getContext();
        api = new ApiHelper();
        api = new ApiHelper();
    ...
    private void shiftSummaryApi() {
        shiftsummaryApiCall = "shiftsummaryApiCall";
    ...
    public void apiResult(String res, String apiName) {
        if (shiftsummaryApiCall.equals("shiftsummaryApiCall")) {
            ...
            try {
                if (res.equals("Server Time Out")) {
                    ...
                    Log.d("getshiftsummaryResponse = ", res);
                    Helper.logLongMessage("getshiftsummaLOGres",res);
    ...
    private void showOptionsDialog() {
        ...
        // Set up single-choice items with immediate action on selection
    ...
    private void showConfirmationDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                shiftSummaryApi();
                // Toast.makeText(getContext(), "Shift End Confirmed", Toast.LENGTH_SHORT).show();
            }
        });
