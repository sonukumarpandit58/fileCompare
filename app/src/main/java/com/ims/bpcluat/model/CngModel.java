...
public class CngModel implements Parcelable {
    String productName;
    String qty;
    String perAmt;
    String totalAmt;
    ...
    protected CngModel(Parcel in) {
        productName = in.readString();
        qty = in.readString();
        perAmt = in.readString();
    ...
    public static final Creator<CngModel> CREATOR = new Creator<CngModel>() {
        @Override
        public CngModel createFromParcel(Parcel in) {
            return new CngModel(in);
        }

        @Override
        public CngModel[] newArray(int size) {
            return new CngModel[size];
        }
    };
