...
import com.ims.bpcluat.databinding.ActivityAlpVoidReceiptBinding;
...
public class AlpVoidReceipt extends AppCompatActivity implements PrintResponseCallBack, ApiHelper.NetworkingApiCallBack {

    ActivityAlpVoidReceiptBinding binding;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAlpVoidReceiptBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        context = this;
        api = new ApiHelper();
        progress = new ProgressDialog(AlpVoidReceipt.this);
...
//            videoPlay();
    ...
    public void getArgumentsData() {
        String voidResponseData = getIntent().getStringExtra("payload");
        mobileNum = getIntent().getStringExtra("mobileNum");
        if (!mobileNum.isEmpty()) {
            mobileNum = mobileNumberMasking(mobileNum);
        }
        Log.d("voidArgData", voidResponseData);
        if (voidResponseData != null) {
            try {
                JSONObject payLoad = new JSONObject(voidResponseData);
                merchantTxnChargeSlip= alpReceiptHelper.alpVoidSlip(AlpVoidReceipt.this, payLoad,"MERCHANT COPY", mobileNum);
                customerTxnChargeSlip = alpReceiptHelper.alpVoidSlip(AlpVoidReceipt.this, payLoad, "CUSTOMER COPY", mobileNum);
                fuelBillSlip = alpReceiptHelper.alpVoidSlip(AlpVoidReceipt.this, payLoad, "FUEL BILL", mobileNum);
                ...
                binding.printBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        progress.setCancelable(false);
                        progress.show();
                        alpReceiptHelper.merchantDialog(AlpVoidReceipt.this, merchantTxnChargeSlip);
...
//                        }
    ...
    public void merchantPrintNo() {
        ...
        Intent intent = new Intent(AlpVoidReceipt.this, SideBarActivity.class);
    ...
    public void merchantPrintYes() {
        ...
        progress.dismiss();
        alpReceiptHelper.customerDialog(AlpVoidReceipt.this, customerTxnChargeSlip);
        alpReceiptHelper.setCallback((PrintResponseCallBack) context);
    }
